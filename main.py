...
def scenario_all(host, current_num, total_num):
    re = os.system("locust -f scenario_all.py --host=%s -c %s -r %s -n %s --no-web --only-summary > scenario2.log" %
...
def scenario_login(host, current_num, total_num):
    re = os.system("locust -f scenario_login.py --host=%s -c %s -r %s -n %s --no-web --only-summary > scenario2.log" %
        (host, current_num, current_num, total_num))
    return 'success'
...
def scenario_browse(host, current_num, total_num):
    re = os.system("locust -f scenario_browse.py --host=%s -c %s -r %s -n %s --no-web --only-summary > scenario2.log" %
        (host, current_num, current_num, total_num))
    return 'success'
